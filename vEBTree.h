...
struct vEB
{
    ...
    Nodeptr root;
    map<int, int> M; //记录u^(1/2),在build（）中初始化
        ...
        else
        {
            ...
            else
            {
                if (x == t->Min)
                {
                    ...
                    x = index(t->u, fclus, _Min(t->clus[fclus]));
                    t->Min = x;
                }
                ...
                if (_Min(t->clus[H]) == -1)
                {
                    ...
                    if (x == t->Max)
                    {
                        ...
                        if (Smax == -1)
                            ...
                            t->Max = index(t->u, Smax, _Max(t->clus[Smax]));
                    }
                }
                else if (x == t->Max)
                {
                    t->Max = index(t->u, H, _Max(t->clus[H]));
                }
            }
        }
    }
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return index(t->u, preclus, offset);
                }
            }
        }
    }
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    return index(t->u, suclus, offset);
                }
            }
        }
    }
    bool _exist(node *t, int x)
    {
        if (x == t->Min || x == t->Max)
            ...
            return _exist(t->clus[high(t->u, x)], low(t->u, x));
    }
